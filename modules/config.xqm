...
(:
 ...
 :)
declare variable $config:default-template :="edition.html";
...
(:~
 ...
 :)
declare variable $config:default-odd :="editions.odd";
...
(:~
 ...
 :)
declare variable $config:odd-available :=("editions.odd");
